...
public class AuctionMessageTranslatorTest {
	...
	@Test 
	public void notifiesAuctionClosedWhenCloseMessgeReceived() {
	...
	public void notifiesAuctionFailedWhenEventTypeMissing() {
		context.checking(new Expectations() {{
			allowing(failureReporter).cannotTranslateMessage(with(any(String.class)), with(any(String.class)), with(any(Exception.class)));
